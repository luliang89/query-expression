...
import { QueryExpression, Joiner } from './query-expression';
...
export class FilterOptions {
    ...
    // setExpression(field: string, value: any, op = Operator.equal, join = Joiner.and) {
    ...
    //     this.expression = this.expression ? this.expression.join(join, exp) : exp;
    // }
